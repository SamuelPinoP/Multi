...
1- Add desired functionality to the Historial Button.
2- Implement the desired functionality for the Notes application.
3- Launch the Notes app as a separate lightweight app.
4- Implement the desired Calendar View API to the Weekly Goals Historial.
5- Have every date were weekly goals were achieved in the Historial button.
