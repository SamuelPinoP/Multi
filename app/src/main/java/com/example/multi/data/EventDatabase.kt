...
fun EventEntity.toModel() = Event(id, title, description, date, address, notify)
fun Event.toEntity() = EventEntity(id, title, description, date, address, notify)
...
fun TrashedEventEntity.toModel() = TrashedEvent(id, title, description, date, address, notify, deleted)
fun TrashedEvent.toEntity() = TrashedEventEntity(id, title, description, date, address, notify, deleted)
