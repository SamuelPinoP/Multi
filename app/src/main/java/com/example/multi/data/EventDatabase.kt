...
interface WeeklyRecordDao {
    ...
    @Insert
    suspend fun insert(record: WeeklyRecordEntity)
}
...
fun WeeklyRecordEntity.toModel() = WeeklyRecord(id, header, frequency, done, weekStart, weekEnd)
fun WeeklyRecord.toEntity() = WeeklyRecordEntity(id, header, frequency, done, weekStart, weekEnd)
