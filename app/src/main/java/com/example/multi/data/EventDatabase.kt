...
fun NoteEntity.toModel() = Note(id, header, content, address, created, lastOpened, scroll, cursor)
fun Note.toEntity() = NoteEntity(id, header, content, address, created, lastOpened, scroll, cursor)
