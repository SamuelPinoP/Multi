...
fun WeeklyGoalRecordEntity.toModel() =
    WeeklyGoalRecord(id, header, completed, frequency, overageCount, weekStart, weekEnd, dayStates)

fun WeeklyGoalRecord.toEntity() =
    WeeklyGoalRecordEntity(id, header, completed, frequency, overageCount, weekStart, weekEnd, dayStates)
