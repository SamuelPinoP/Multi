...
fun EventEntity.toModel() = Event(id, title, description, date, address, notificationTime)
fun Event.toEntity() = EventEntity(id, title, description, date, address, notificationTime)
