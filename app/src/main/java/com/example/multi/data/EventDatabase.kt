...
fun EventEntity.toModel() = Event(id, title, description, date, address, notifyTime)
fun Event.toEntity() = EventEntity(id, title, description, date, address, notifyTime)
...
fun TrashedEventEntity.toModel() = TrashedEvent(id, title, description, date, address, notifyTime, deleted)
fun TrashedEvent.toEntity() = TrashedEventEntity(id, title, description, date, address, notifyTime, deleted)
