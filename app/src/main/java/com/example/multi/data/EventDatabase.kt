...
fun NoteEntity.toModel() =
    Note(id, header, content, created, lastOpened, scroll, cursor, attachmentUri, textColor)

fun Note.toEntity() =
    NoteEntity(id, header, content, created, lastOpened, scroll, cursor, attachmentUri, textColor)

fun TrashedNoteEntity.toModel() =
    TrashedNote(id, header, content, created, deleted, attachmentUri, textColor)

fun TrashedNote.toEntity() =
    TrashedNoteEntity(id, header, content, created, deleted, attachmentUri, textColor)
